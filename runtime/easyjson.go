...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoRuntime21(out *jwriter.Writer, in GetPropertiesReturns) {
	...
	if len(in.PrivateProperties) != 0 {
		...
		first = false
		out.RawString("\"privateProperties\":")
		if in.PrivateProperties == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			out.RawString("null")
		} else {
			out.RawByte('[')
