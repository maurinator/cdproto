...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoTarget9(out *jwriter.Writer, in GetBrowserContextsReturns) {
	...
	if len(in.BrowserContextIds) != 0 {
		...
		first = false
		out.RawString("\"browserContextIds\":")
		if in.BrowserContextIds == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			out.RawString("null")
		} else {
			out.RawByte('[')
