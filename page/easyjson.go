...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoPage24(out *jwriter.Writer, in PrintToPDFParams) {
	...
	if in.PreferCSSPageSize {
		...
		first = false
		out.RawString("\"preferCSSPageSize\":")
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoPage31(out *jwriter.Writer, in InstallabilityError) {
	...
	first = false
	out.RawString("\"errorId\":")
	out.String(string(in.ErrorID))
	if !first {
		out.RawByte(',')
	}
	first = false
	out.RawString("\"errorArguments\":")
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoPage43(out *jwriter.Writer, in GetInstallabilityErrorsReturns) {
	...
	if len(in.InstallabilityErrors) != 0 {
		...
		first = false
		out.RawString("\"installabilityErrors\":")
		if in.InstallabilityErrors == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			out.RawString("null")
		} else {
			out.RawByte('[')
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoPage61(out *jwriter.Writer, in EventJavascriptDialogOpening) {
	...
	first = false
	out.RawString("\"hasBrowserHandler\":")
